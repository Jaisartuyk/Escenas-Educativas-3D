...
export const DEFAULT_DOCENTES: Docente[] = [
  { id: '1', titulo: 'Ing.',  nombre: 'Giler Tapia, Oswaldo Xavier',   materias: ['MATEMATICA', 'FISICA'], jornada: 'AMBAS' },
  { id: '2', titulo: 'Lcdo.', nombre: 'Parrales Alfredo Juan',          materias: ['EE.SS', 'HISTORIA', 'FILOSOFIA'], jornada: 'AMBAS' },
  { id: '3', titulo: 'Msc.',  nombre: 'Cedeño Carvajal, José Luis',     materias: ['ECA', 'CIUDADANIA', 'EMPRENDIMIENTO'], jornada: 'AMBAS' },
  { id: '4', titulo: 'Lcdo.', nombre: 'Haz Bernal, Barkly',             materias: ['INGLES'], jornada: 'AMBAS' },
  { id: '5', titulo: 'Lcdo.', nombre: 'Palacios Nieto, George Steven',  materias: ['ROBOTICA'], jornada: 'AMBAS' },
  { id: '6', titulo: 'Lcdo.', nombre: 'Yagual Sánchez, Johnny Luis',    materias: ['COMPUTACION'], jornada: 'AMBAS' },
]
